 ...
 <html>
    ...
    <body>
        ...
        <?php
            ...
            // create a prepared statement to get specific plan information
            ...
            // Display plan info in a formatted manner
            if($st->num_rows > 0) {
        ...
        <?php
            ...
            // button to add plan to library
            echo "<form action='PlanAdded.php?user=$user&plan_id=$plan_id' method='POST'>";
            echo "<input type='submit' value = 'Add Plan to Library'>";
            echo "</form>";
            
            // button to return to search engine
            echo "<form action='SearchEngine.php?user=$user' method='POST'>";
            echo "<input type='submit' value = 'Back to Search'>";
            echo "</form>";
