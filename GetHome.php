 ...
 * DESCRIPTION: This file is the user unique home page after the user is logged in for TravelSlate.
 ---------------------------------------------------------------------->
 ...
 <html>
    ...
    <body>
        ...
        <?php
            ...
            $q = "SELECT first_name, last_name FROM Account WHERE user = ?";
            $st = $cn->stmt_init();
            $st->prepare($q);
            ...
            // Display welcome home user message
            if($st->num_rows > 0) {
        ...
        <?php
            ...
            // display saved plans in a formatted table if there are any
            if($st->num_rows > 0) {
        ...
        <h3> My Reviews </h3>
        <?php
             // create a prepared statement to query reviews made by user
             ...
             // check if there are any reviews written by user and display them in formatted table
             if($st->num_rows > 0) {
             ...
             // Button to get to Search Engine
